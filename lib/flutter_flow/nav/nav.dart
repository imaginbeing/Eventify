...
const debugRouteLinkMap = {
  ...
  '/profile':
      'https://app.flutterflow.io/project/eventer-vmjosc?tab=uiBuilder&page=Profile',
  '/eventPage':
  ...
  '/admin':
      'https://app.flutterflow.io/project/eventer-vmjosc?tab=uiBuilder&page=Admin',
  '/organizerPage':
      'https://app.flutterflow.io/project/eventer-vmjosc?tab=uiBuilder&page=OrganizerPage',
  '/login':
      'https://app.flutterflow.io/project/eventer-vmjosc?tab=uiBuilder&page=Login'
};
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/eventCreation',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'EventCreation')
              : EventCreationWidget(),
        ),
        FFRoute(
          name: 'BuyPage',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Neverkillyourself.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
